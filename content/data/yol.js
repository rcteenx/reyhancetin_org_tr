...
export const bilincliYollar = {
  h2: "Bilinçli Çalışma ve Ötesindeki Yollar",
  ...
  items: [
    ...
    {
      title: "Birlik & Sevgi",
      info: "İçimizde 'ben' olarak algıladığımız şey, diğer farkındalıklı varlıkların da içinde 'ben' olarak algıladığı şey ile aynı! Bunu deneyimle doğrulandığında, bildiğimiz anlamıyla yolculuğun sonu gelmiş olabilir.",
    },
  ],
};
